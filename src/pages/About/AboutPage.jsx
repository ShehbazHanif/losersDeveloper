...
/* Img */
import imgabout from "../../img/dp2.png";
          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id="about-info-1"
                  defaultMessage="Hi, I'm Shahbaz Hanif, a student at the Szabist University Islamabad; I consider myself a person passionate about programming and web development since in 2021 I had the opportunity to get to know this world of the front-end and I was able to create my first web page only using HTML and CSS from there, I felt a great passion for web development, since you can do amazing things knowing how to use HTML, CSS, JavaScript and to this day I still feel that same passion when I create a web page."
                />
              </p>
